            ...
            <div className="col-12">
              <div className="it-testimonial-section-title-box text-center mb-70">
                <span className="it-section-subtitle">
                  ...
                  Testimonial</span>
                <h4 className="it-section-title">What Our Learners
                  Say About<br /> Educeet’s Impact and Value</h4>
              </div>
            </div>
          </div>
                        ...
                        <div className="col-lg-7 col-md-7">
                          <div className="it-testimonial-content">
                            ...
                            <div className="it-testimonial-text">
                              <h5 className="mb-30">Educeet transformed my learning journey! The platform is intuitive, the courses are top-notch, and the support is exceptional. I’ve gained real skills and confidence. Highly recommended for anyone serious about education.</h5>
                            </div>
                            <div className="it-testimonial-bottom d-flex align-items-center justify-content-between">
                              <div className="it-testimonial-avatar-info">
                                <h5 className="it-testimonial-avatar-name">Michelle Logan</h5>
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 col-md-7">
                          <div className="it-testimonial-content">
                            ...
                            <div className="it-testimonial-bottom d-flex align-items-center justify-content-between">
                              <div className="it-testimonial-avatar-info">
                                <h5 className="it-testimonial-avatar-name">Christopher Story</h5>
                                <span>Foundr & CEO  UIPainter</span>
                              </div>
                              <img src="assets/img/testimonial/icon.png" alt="" />
                            </div>
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 col-md-7">
                          <div className="it-testimonial-content">
                            ...
                            <div className="it-testimonial-bottom d-flex align-items-center justify-content-between">
                              <div className="it-testimonial-avatar-info">
                                <h5 className="it-testimonial-avatar-name">Denise Germany</h5>
                                <span>Foundr & CEO  UIPainter</span>
                              </div>
                              <img src="assets/img/testimonial/icon.png" alt="" />
                            </div>
                      ...
                      <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 col-md-7">
                          <div className="it-testimonial-content">
                            ...
                            <div className="it-testimonial-bottom d-flex align-items-center justify-content-between">
                              <div className="it-testimonial-avatar-info">
                                <h5 className="it-testimonial-avatar-name">Douglas Taylor</h5>
                                <span>Foundr & CEO  UIPainter</span>
                              </div>
                              <img src="assets/img/testimonial/icon.png" alt="" />
                            </div>
