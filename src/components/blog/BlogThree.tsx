            ...
            <div className="col-12">
              <div className="it-blog-section-title-box text-center mb-65">
                <span className="it-section-subtitle">
                  ...
                  News Post</span>
                <h4 className="it-section-title">Latest Insights, Tips, and <br /> Updates from
                  Educeet</h4>
              </div>
            </div>
          </div>
              ...
              <div className="it-blog-2-item mb-35">
                ...
                <div className="it-blog-2-content z-index-2">
                  ...
                  <h5 className="it-blog-title mb-15">
                    <Link className="border-line" to="/blog-details-left-sidebar">How to Avoid the Biggest College Admission Mistakes</Link>
                  </h5>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 wow itfadeUp" data-wow-duration=".9s"
              ...
              <div className="it-blog-2-item mb-35">
                ...
                <div className="it-blog-2-content z-index-2">
                  ...
                  <h5 className="it-blog-title mb-15">
                    <Link className="border-line" to="/blog-details-left-sidebar">How Digital Platforms Are Shaping Business Schools</Link>
                  </h5>
                  <div className="it-blog-btn">
                    <Link to="/blog-details-left-sidebar" className="it-btn-yellow">
                      <span>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 wow itfadeUp" data-wow-duration=".9s"
              ...
              <div className="it-blog-2-item mb-35">
                ...
                <div className="it-blog-2-content z-index-2">
                  ...
                  <h5 className="it-blog-title mb-15">
                    <Link className="border-line" to="/blog-details-left-sidebar">Why Business Students Need Tech Skills for the Future</Link>
                  </h5>
                  <div className="it-blog-btn">
                    <Link to="/blog-details-left-sidebar" className="it-btn-yellow">
                      <span>
