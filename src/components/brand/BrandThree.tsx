      ...
      <div className="container">
         <div className="row">
               ...
               <div className="it-brand-3-left">
                  <div className="it-brand-section-title-box mb-35">
                     <span className="it-section-subtitle">
                        ...
                        Our Partner</span>
                     <h4 className="it-section-title">The trusted market leader <br /> in talent
                        transformation <br /> through education</h4>
                  </div>
            ...
            <div className="col-xl-6 col-lg-6 wow itfadeRight" data-wow-duration=".9s"
                  data-wow-delay=".7s">
               <div className="it-brand-3-wrap">
                  <div className="row gx-0 row-cols-xl-3">
                     <div className="col">
                        <div className="it-brand-3-item style-1">
                           <img src="assets/img/brand/brand-1-1.png" alt="" />
                        </div>
                     </div>
                     <div className="col">
                        <div className="it-brand-3-item style-2 text-center">
                           <img src="assets/img/brand/brand-1-2.png" alt="" />
                        </div>
                     </div>
                     <div className="col">
                        <div className="it-brand-3-item style-3 text-end">
